  ...
  <Layout>
    <template #drawer-help>
      <div class="q-px-md">
        ...
        <div class="text-3 text-gray-6 q-mb-md">Quick list menu</div>

        <div
          v-for="menu in menus"
          :key="menu.id"
          class="
            text-3 text-secondary text-weight-medium text-capitalize
            q-mb-sm
          "
        >
          {{ menu.label }}
    ...
    return {
      menus: [
        ...
        },
        {
          ...
          label: "form",
          route: "form-settings",
          icon: "eva-layout-outline",
          activeIcon: "eva-layout",
          for: ["ADMIN"],
        },
        {
          id: this.$nano.id(),
        ...
        },
        {
          ...
          activeIcon: "eva-options",
          for: ["ADMIN"],
        },
        {
          id: this.$nano.id(),
          label: "insights",
          route: "insight-settings",
          icon: "o_pie_chart",
          activeIcon: "pie_chart",
          for: ["ADMIN"],
        },
        {
          id: this.$nano.id(),
